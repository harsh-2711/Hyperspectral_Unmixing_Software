...
int main(int argc, char* argv[])
{
	...
	if(argc !=  4)
	{
		printf("EXECUTION ERROR LSU Iterative: Parameters are not correct.");
	...
	if(error != 0)
	{
		printf("EXECUTION ERROR LSU Iterative: Error reading header file: %s.", header_filename);
		fflush(stdout);
		exit(-1);
	}
	...
	if(error != 0)
	{
		printf("EXECUTION ERROR LSU Iterative: Error reading image file: %s.", argv[1]);
		fflush(stdout);
		exit(-1);
	}
	...
	if(error != 0)
	{
		printf("EXECUTION ERROR LSU Iterative: Error reading endmembers header file: %s.", header_filename);
		fflush(stdout);
		return error;
	}
	...
	printf("Iterative LSU: %f segundos", (double)(end - start) / CLOCKS_PER_SEC);
	fflush(stdout);
	//**************************************************
	...
	if(error != 0)
	{
		printf("EXECUTION ERROR LSU Iterative: Error writing abundances header file: %s.", header_filename);
		fflush(stdout);
		return error;
	}
	...
	if(error != 0)
	{
		printf("EXECUTION ERROR LSU Iterative: Error writing abundances file: %s.", argv[3]);
		fflush(stdout);
		return error;
	}
